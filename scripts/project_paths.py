...
QUALITY_REPORT_FILE = DATA_DIR / "database" / "quality_report_2026.csv"
GENDER_CONFLICT_REPORT_FILE = DATA_DIR / "database" / "gender_conflicts_2026.csv"
IMPORT_MANIFEST_FILE = DATA_DIR / "database" / "import_manifest_2026.csv"
IMPORT_REVIEW_FILE = DATA_DIR / "database" / "import_review_2026.csv"
IMPORT_INBOX_DIR = INPUT_RESULTATER_DIR / "inbox"
